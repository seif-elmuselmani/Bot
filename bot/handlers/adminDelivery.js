 ...
 *   2. File only     → sends the document to the user & marks order completed
 *   3. File + Text   → sends the document WITH a custom caption to the user & marks order completed
 * 
